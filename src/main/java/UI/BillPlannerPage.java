	...
	public BillPlannerPage() {
		...
		deleteMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					BillPlannerPage bp = new BillPlannerPage();
					bp.billTable = DBUtil.query(User.getLoginAs(), "tag", "expense");
					mainBpPage.dispose();
					mainBpPage.setVisible(false);
					bp = new BillPlannerPage();
					bp.mainBpPage.setVisible(false);
